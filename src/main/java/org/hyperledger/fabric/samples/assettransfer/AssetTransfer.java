...
public final class AssetTransfer implements ContractInterface {
    ...
    /**
     * Duplicates an asset and assigns it to a new owner while keeping the original asset with the previous owner
     *
     * @param ctx the transaction context
     * @param assetID the ID of the asset being duplicated
     * @param newOwner the new owner
     * @return the duplicated new asset
     */
    @Transaction(intent = Transaction.TYPE.SUBMIT)
    public Asset DuplicateAsset(final Context ctx, final String assetID, final String newOwner) {
        ...
        final String newAssetID = "duplicated" + assetID;
